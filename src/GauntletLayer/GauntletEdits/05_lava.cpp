...
void RedesignedGauntletLayer::editLavaGauntlet() {
    ...
    if (bgParticleNode) {
        CCParticleSystemQuad* bgParticles = GameToolbox::particleFromString("65a-1a2a0.45a26a90a90a0a0a300a0a15a0a0a0a0a0a30a10a90a0a1a0a0.313726a0a0a0a0.15a0.05a1200a20a90a0a1a0a0.501961a0a0a0a0.1a0.15a0.35a0a0.7a0a0a0a0a0a0a0a0a1a1a0a0a0a32a0a0a0a0a0a0a0a0a0a0a0a0a0a0", NULL, false);
