...
bool RedesignedGauntletSelectLayer::init(int gauntletType) {
    ...
    spriteFrameCache->addSpriteFramesWithFile("SecretSheet.plist");
    ...
    CCMenuItemSpriteExtra* lockBtn = CCMenuItemSpriteExtra::create(
        CCSpriteGrayscale::createWithSpriteFrameName("secretDoor_closed_001.png"),
        this,
        menu_selector(RedesignedGauntletSelectLayer::onLock)
    );
    lockBtn->m_scaleMultiplier = 1.0;
    lockBtn->m_colorDip = 1.0;
    lockBtn->m_baseScale = 0.5;
