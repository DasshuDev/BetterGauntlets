...
std::string getGauntletInfo(GauntletType gauntletType) {
    switch (gauntletType) {
        ...
        case GauntletType::Fire: {
            return "A huge fiery landscape where the skies are filled with intense flames, and the charred ground radiates an unusual warmth. Do you think you can handle the heat?";
        }
