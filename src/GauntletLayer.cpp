...
class $modify(RedesignedGauntletLayer, GauntletLayer) {
	...
	bool init(GauntletType p0) {
		...
		switch(m_gauntletType) {
			...
			case GauntletType::Fire: { 
				editGauntletSingle("Fire", ccc3(63, 29, 9), ccc3(255, 255, 0), ccc3(231, 79, 0), ccc3(255, 166, 0));
			...
			case GauntletType::Ice: { // 2
				editGauntletSingle("Ice", ccc3(8, 68, 83), ccc3(192, 236, 255), ccc3(0, 174, 255), ccc3(141, 219, 255));
			...
			case GauntletType::Poison: { // 3
				editGauntletSingle("Poison", ccc3(20, 63, 9), ccc3(229, 255, 0), ccc3(80, 179, 0), ccc3(72, 255, 0));
			...
			case GauntletType::Shadow: { // 4
				editGauntletSingle("Shadow", ccc3(46, 19, 45), ccc3(177, 1, 255), ccc3(59, 0, 141), ccc3(162, 0, 255));
			...
			case GauntletType::Lava: { // 5
				editGauntletSingle("Lava", ccc3(63, 9, 9), ccc3(255, 209, 56), ccc3(255, 51, 0), ccc3(190, 13, 0));
			...
			case GauntletType::Bonus: { // 6
				editGauntletSingle("Bonus", ccc3(30, 54, 85), ccc3(255, 241, 20), ccc3(226, 102, 0), ccc3(245, 193, 13));
			...
			case GauntletType::Chaos: { // 7
				editGauntletSingle("Chaos", ccc3(33, 12, 6), ccc3(255, 145, 0), ccc3(255, 18, 0), ccc3(255, 128, 0));
				GameManager::get()->loadBackground(14);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_14_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Demon: { // 8
				editGauntletSingle("Demon", ccc3(29, 29, 29), ccc3(202, 81, 81), ccc3(99, 3, 3), ccc3(73, 73, 73));
			...
			case GauntletType::Time: { // 9
				editGauntletSingle("Time", ccc3(55, 79, 107), ccc3(248, 219, 138), ccc3(243, 100, 17), ccc3(26, 132, 220));
			...
			case GauntletType::Crystal: { // 10
				editGauntletSingle("Crystal", ccc3(51, 2, 31), ccc3(248, 223, 255), ccc3(246, 58, 218), ccc3(248, 205, 251));
			...
			case GauntletType::Magic: { // 11
				editGauntletSingle("Magic", ccc3(14, 16, 51), ccc3(77, 250, 255), ccc3(36, 52, 145), ccc3(14, 159, 255));
			...
			case GauntletType::Spike: { // 12
				editGauntletSingle("Spike", ccc3(54, 37, 4), ccc3(245, 174, 68), ccc3(124, 91, 1), ccc3(177, 116, 43));
			...
			case GauntletType::Monster: { // 13
				editGauntletSingle("Monster", ccc3(23, 58, 28), ccc3(65, 214, 35), ccc3(8, 110, 13), ccc3(111, 223, 20));
				GameManager::get()->loadBackground(38);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_38_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Doom: { // 14
				editGauntletSingle("Doom", ccc3(48, 36, 33), ccc3(141, 133, 128), ccc3(75, 69, 60), ccc3(147, 98, 65));
			...
			case GauntletType::Death: { // 15
				editGauntletSingle("Death", ccc3(22, 22, 22), ccc3(100, 100, 100), ccc3(48, 48, 48), ccc3(103, 103, 103));
			...
			case GauntletType::Forest: { // 16
				editGauntletSingle("Forest", ccc3(33, 68, 34), ccc3(148, 255, 98), ccc3(61, 165, 20), ccc3(155, 201, 14));
			...
			case GauntletType::Rune: { // 17
				editGauntletSingle("Rune", ccc3(46, 18, 0), ccc3(227, 130, 33), ccc3(100, 28, 0), ccc3(251, 162, 48));
				GameManager::get()->loadBackground(15);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_15_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Force: { // 18
				editGauntletSingle("Force", ccc3(53, 50, 64), ccc3(130, 112, 193), ccc3(160, 19, 74), ccc3(161, 153, 193));
			...
			case GauntletType::Spooky: { // 19
				editGauntletSingle("Spooky", ccc3(55, 167, 173), ccc3(232, 52, 24), ccc3(109, 43, 17), ccc3(55, 167, 173));
				GameManager::get()->loadBackground(16);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_16_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Dragon: { // 20
				editGauntletSingle("Dragon", ccc3(46, 0, 0), ccc3(201, 33, 33), ccc3(92, 35, 35), ccc3(242, 43, 14));
			...
			case GauntletType::Water: { // 21
				editGauntletSingle("Water", ccc3(13, 11, 48), ccc3(78, 212, 230), ccc3(18, 80, 151), ccc3(71, 161, 255));
			...
			case GauntletType::Haunted: { // 22
				editGauntletSingle("Haunted", ccc3(28, 36, 33), ccc3(255, 255, 110), ccc3(72, 45, 54), ccc3(106, 143, 131));
				GameManager::get()->loadBackground(16);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_16_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Acid: { // 23
				editGauntletSingle("Acid", ccc3(45, 38, 17), ccc3(208, 255, 0), ccc3(162, 255, 24), ccc3(172, 141, 59));
			...
			case GauntletType::Witch: { // 24
				editGauntletSingle("Witch", ccc3(0, 44, 25), ccc3(66, 99, 125), ccc3(35, 13, 46), ccc3(131, 194, 172));
				GameManager::get()->loadBackground(26);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_26_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Power: { // 25
				editGauntletSingle("Power", ccc3(72, 58, 42), ccc3(206, 174, 149), ccc3(116, 87, 56), ccc3(187, 156, 128));
				GameManager::get()->loadBackground(38);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_38_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Potion: { // 26
				editGauntletSingle("Potion", ccc3(58, 30, 52), ccc3(255, 0, 144), ccc3(139, 0, 148), ccc3(213, 0, 145));
			...
			case GauntletType::Snake: { // 27
				editGauntletSingle("Snake", ccc3(66, 31, 114), ccc3(209, 167, 107), ccc3(110, 57, 34), ccc3(141, 66, 242));
			...
			case GauntletType::Toxic: { // 28
				editGauntletSingle("Toxic", ccc3(41, 4, 43), ccc3(0, 248, 0), ccc3(9, 87, 8), ccc3(212, 102, 199));
				GameManager::get()->loadBackground(31);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_31_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Halloween: { // 29
				editGauntletSingle("Halloween", ccc3(39, 36, 12), ccc3(255, 100, 3), ccc3(173, 34, 34), ccc3(128, 122, 42));
				GameManager::get()->loadBackground(16);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_16_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Treasure: { // 30
				editGauntletSingle("Treasure", ccc3(29, 39, 33), ccc3(249, 129, 48), ccc3(136, 39, 0), ccc3(166, 187, 145));
				GameManager::get()->loadBackground(42);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_42_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Ghost: { // 31
				editGauntletSingle("Ghost", ccc3(41, 41, 41), ccc3(226, 226, 226), ccc3(153, 153, 153), ccc3(121, 203, 213));
				GameManager::get()->loadBackground(16);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_16_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Spider: { // 32
				editGauntletSingle("Spider", ccc3(44, 52, 56), ccc3(141, 192, 209), ccc3(75, 66, 91), ccc3(147, 173, 184));
			...
			case GauntletType::Gem: { // 33
				editGauntletSingle("Gem", ccc3(39, 38, 66), ccc3(201, 246, 229), ccc3(188, 129, 220), ccc3(154, 229, 255));
				GameManager::get()->loadBackground(14);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_14_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Inferno: { // 34
				editGauntletSingle("Inferno", ccc3(70, 24, 54), ccc3(255, 223, 67), ccc3(208, 58, 0), ccc3(255, 165, 12));
				GameManager::get()->loadBackground(21);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_21_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Portal: { // 35
				editGauntletSingle("Portal", ccc3(31, 49, 77), ccc3(255, 50, 140), ccc3(109, 34, 86), ccc3(255, 42, 128));
				GameManager::get()->loadBackground(57);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_57_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Strange: { // 36
				editGauntletSingle("Strange", ccc3(42, 52, 3), ccc3(203, 134, 255), ccc3(112, 59, 117), ccc3(82, 132, 2));
				GameManager::get()->loadBackground(17);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_17_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Fantasy: { // 37
				editGauntletSingle("Fantasy", ccc3(49, 57, 24), ccc3(185, 255, 92), ccc3(73, 126, 38), ccc3(195, 228, 0));
			...
			case GauntletType::Christmas: { // 38
				editGauntletSingle("Christmas", ccc3(19, 43, 68), ccc3(158, 255, 250), ccc3(68, 118, 133), ccc3(219, 246, 255));
				GameManager::get()->loadBackground(29);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_29_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Surprise: { // 39
				editGauntletSingle("Surprise", ccc3(42, 52, 3), ccc3(213, 52, 40), ccc3(100, 41, 18), ccc3(147, 180, 13));
			...
			case GauntletType::Mystery: { // 40
				editGauntletSingle("Mystery", ccc3(75, 51, 1), ccc3(255, 233, 23), ccc3(255, 146, 0), ccc3(255, 214, 21));
			...
			case GauntletType::Cursed: { // 41
				editGauntletSingle("Cursed", ccc3(46, 14, 43), ccc3(81, 255, 0), ccc3(8, 121, 4), ccc3(170, 97, 173));
			...
			case GauntletType::Cyborg: { // 42
				editGauntletSingle("Cyborg", ccc3(50, 50, 50), ccc3(182, 228, 237), ccc3(63, 88, 123), ccc3(156, 209, 224));
			...
			case GauntletType::Castle: { // 43
				editGauntletSingle("Castle", ccc3(50, 67, 87), ccc3(190, 214, 230), ccc3(105, 119, 136), ccc3(130, 163, 163));
				GameManager::get()->loadBackground(19);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_19_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Grave: { // 44
				editGauntletSingle("Grave", ccc3(23, 32, 31), ccc3(176, 195, 207), ccc3(80, 66, 87), ccc3(117, 161, 151));
				GameManager::get()->loadBackground(16);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_16_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Temple: { // 45
				editGauntletSingle("Temple", ccc3(51, 59, 21), ccc3(255, 226, 184), ccc3(116, 93, 63), ccc3(207, 228, 150));
				GameManager::get()->loadBackground(30);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_30_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::World: { // 46
				editGauntletSingle("World", ccc3(79, 80, 130), ccc3(122, 233, 31), ccc3(54, 109, 33), ccc3(133, 148, 165));
				GameManager::get()->loadBackground(27);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_27_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Galaxy: { // 47
				editGauntletSingle("Galaxy", ccc3(40, 26, 44), ccc3(255, 180, 255), ccc3(181, 9, 149), ccc3(244, 138, 255));
				GameManager::get()->loadBackground(21);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_21_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Universe: { // 48
				editGauntletSingle("Universe", ccc3(36, 70, 105), ccc3(255, 252, 104), ccc3(255, 1, 136), ccc3(255, 171, 103));
				GameManager::get()->loadBackground(32);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_32_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
			...
			case GauntletType::Discord: { // 49
				editGauntletSingle("Discord", ccc3(44, 47, 51), ccc3(88, 101, 212), ccc3(35, 41, 99), ccc3(110, 122, 244));
			...
			case GauntletType::Split: { // 50
				editGauntletSingle("Split", ccc3(49, 50, 65), ccc3(255, 110, 237), ccc3(113, 60, 107), ccc3(109, 110, 151));
			...
			case GauntletType::NCS: { // 51
				editGauntletSingle("NCS I", ccc3(16, 131, 131), ccc3(32, 254, 254), ccc3(9, 71, 71), ccc3(32, 254, 254));
				GameManager::get()->loadBackground(21);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_21_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
				m_backgroundSprite->setPositionY(-250);
			...
			case GauntletType::NCS2: { // 52
				editGauntletSingle("NCS II", ccc3(136, 81, 136), ccc3(255, 152, 255), ccc3(80, 47, 80), ccc3(255, 152, 255));
				GameManager::get()->loadBackground(21);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_21_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
				m_backgroundSprite->setPositionY(-250);
			...
			case GauntletType::Space: { // 53
				editGauntletSingle("Space", ccc3(38, 79, 87), ccc3(119, 188, 235), ccc3(19, 77, 145), ccc3(91, 228, 254));
			...
			case GauntletType::Cosmos: { // 54
				editGauntletSingle("Cosmos", ccc3(53, 36, 20), ccc3(252, 226, 128), ccc3(254, 84, 0), ccc3(253, 192, 50));
				GameManager::get()->loadBackground(13);
				auto bgTexture = CCTextureCache::sharedTextureCache()->textureForKey("game_bg_13_001.png");
				this->m_backgroundSprite->setTexture(bgTexture);
	...
	void editGauntletSingle(const std::string& title, ccColor3B bgColor, ccColor3B titleColor, ccColor3B highlightColor, ccColor3B cornerColor) {
