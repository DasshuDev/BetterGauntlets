...
class editGauntletSingle {
    public:
        static void editGauntletSingle(std::string title, cocos2d::ccColor3B titleColor, cocos2d::ccColor3B bgColor, cocos2d::ccColor3B highlightColor) {
