...
void RedesignedGauntletLayer::editMagicGauntlet() {
	...
	if (enableParticles) {
        ...
        if (bgParticleNode1) {
            CCParticleSystemQuad* bgParticles = GameToolbox::particleFromString("35a-1a2a0.45a14a90a20a0a0a300a200a0a0a0a0a0a0a10a5a0a43a0a0a0.537255a1a1a1a1a1a20a5a0a38a0a0a0.027451a0a1a0a0.5a0.15a0a0a0.45a0a0a0a0a0a0a0a0a2a1a0a0a0a169a0a0a0a0a0a0a0a0a0a0a0a0a0a0", NULL, false);
        ...
        if (bgParticleNode2) {
            CCParticleSystemQuad* bgParticles = GameToolbox::particleFromString("83a-1a2a0.45a33a90a90a0a0a300a0a0a0a11a0a0a0a350a10a90a0a0.411765a0a0.517647a0a1a0.4a0.3a0.05a500a20a90a0a0a0a0a0a0.34902a0a0.1a0.15a1a0a1a0a0a0a0a0a0a0a0a2a1a0a0a0a32a0a0a0a0a0a0a0a0a0a0a0a0a0a0", NULL, false);
        ...
        if (bgParticleNode4) {
            CCParticleSystemQuad* bgParticles = GameToolbox::particleFromString("83a-1a2a0.45a33a90a90a0a0a0a200a0a0a11a0a0a0a350a10a90a0a0.411765a0a0.517647a0a1a0.4a0.3a0.05a500a20a90a0a0a0a0a0a0.34902a0a0.1a0.15a1a0a1a0a0a0a0a0a0a0a0a2a1a0a0a0a32a0a0a0a0a0a0a0a0a0a0a0a0a0a0", NULL, false);
