...
void RedesignedGauntletLayer::editPoisonGauntlet() {
    ...
    if (bgParticleNode2) {
        CCParticleSystemQuad* bgParticles = GameToolbox::particleFromString("65a-1a2a0.45a26a90a90a0a0a300a0a0a30a0a0a0a0a50a5a0a43a0.309804a0a0.905882a0a0.360784a0a0.1a0.05a100a10a0a38a0.00392157a0a0.486275a0a0.0392157a0a0a0.15a0.39a0a0.5a0a0a0a0a0a0a0a0a2a1a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0", NULL, false);
        bgParticles->setPosition(ccp(winSize.width / 2, director->getScreenBottom() - 10));
        bgParticles->setZOrder(-2);
        this->addChild(bgParticles);
    }
