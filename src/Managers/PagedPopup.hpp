...
// Shared base for popups that flip between a fixed set of pages using left/right
// arrow buttons anchored just outside the popup's edges. This only owns the
// arrows, the current page index, and turning/clamping between pages -
...
protected:
    ...
    void setupPageArrows(float arrowY = -1.f);
